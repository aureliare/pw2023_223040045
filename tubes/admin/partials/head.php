...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand me-auto ms-lg-0 ms-3 text-uppercase fw-bold" href="#">News.OR</a>
        </div>
    </nav>
        ...
        <div class="offcanvas-body p-0">
            <nav class="navbar-dark">
                <ul class="navbar-nav">
                    ...
                    <li>
                        <!-- <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="logout.php">
